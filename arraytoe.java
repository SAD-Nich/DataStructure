...
/** Tic-Tac-Toe: Two-player console.*/
public class arraytoe {
    ...
    public void updateBoard() {
        ...
        do {
            if (currentPlayer == 'x') {
                System.out.print("Player 'X', Your turn : ");
            } else {
                System.out.print("Player 'O', Your turn : ");
            }
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            if (t.isBoardFull()) {
                System.out.println("Its a draw fair and square !");
                gameStatus = true;
            }
            // Switch player
            t.changePlayer();
